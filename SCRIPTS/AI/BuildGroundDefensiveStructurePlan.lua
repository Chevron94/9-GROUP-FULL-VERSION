...
--	Category = "Build_Ground_Defensive_Structure"
	...
	{
		"StructureForce",
		"E_Ground_Base_Shield | R_Ground_Base_Shield | Empire_Ground_Shutter_Shield | Rebel_Ground_Shutter_Shield | E_Galactic_Turbolaser_Tower_Defenses | R_Galactic_Turbolaser_Tower_Defenses | Ground_Magnepulse_Cannon | 9Group_Base_Shield | SUPER_ROCKET_ATTACK = 1"
	}
	}
