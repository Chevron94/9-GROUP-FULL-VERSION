...
Create_Generic_Object("Entry_effect_small",Object,Object.Get_Owner())
...
Create_Generic_Object("Entry_effect_small",StartPosMarker,Object.Get_Owner())
--StartPosMarker.Attach_Particle_Effect("Medium_Explosion_Space")
st=2
end
elseif st==2 then
MarkerObj=Find_First_Object("Teleport_Marker")
Create_Generic_Object("Entry_effect_small",MarkerObj,Object.Get_Owner())
