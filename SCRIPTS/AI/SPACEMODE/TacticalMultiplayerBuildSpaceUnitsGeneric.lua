...
function Definitions()
	...
	TaskForce = {
		...
		,"Crusader_Gunship | Interceptor4_Frigate | Kedalbe_Battleship | Krayt_Class_Destroyer | Skipray_Squadron | StarViper_Squadron | Titan_Cruiser | Eclipse_Star_Destroyer | Vengeance_Frigate | SUPERFLAGSHIP | Daleks_Squad | Dalek_Saucer = 0,3"
		...
		,"X-301_Squadron | F-302_Squadron | Gracefighter_Squadron | Matan | Andromeda_Ship | Predel | Destroyer | Differencial | ALGEM | FV_Nebula | Ears_ship | Orion  | FV_Sorveign | Jumper_Squadron | FV_Type11_Squadron = 0,3"
